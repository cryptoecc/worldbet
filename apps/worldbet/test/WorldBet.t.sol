...
contract WorldBetTest is Test {
    ...
    function testFuzz_FeeSplitConservation(uint96 amount) public {
        ...
        // Fee is exactly 3% (with potential 1-2 wei rounding loss redirected to burn).
        assertGe(fees * 10000, amount * 300 - 3 * 10000); // >= 3% - 3 wei
        assertLe(fees * 10000, amount * 300);             // <= 3% nominal
    }
